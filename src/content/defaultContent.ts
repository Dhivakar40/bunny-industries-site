...
//  to Upstash Redis / localStorage; ContentContext merges those
//  over this object at runtime.
// ============================================================
...
const defaultContent: SiteContent = {
  ...
  "hero": {
    ...
    "slideshowImages": [
      "https://dgmoij6awx5wsetk.public.blob.vercel-storage.com/Screenshot%202026-09-12%20155317.png",
      "https://dgmoij6awx5wsetk.public.blob.vercel-storage.com/Screenshot%202026-09-12%20155300.png",
      "https://dgmoij6awx5wsetk.public.blob.vercel-storage.com/Screenshot%202026-09-12%20155333.png"
    ],
  ...
  "about": {
    ...
    "paragraph1": "Established in 2015\nunder the leadership of Founder &amp; Proprietor Mr. Varatharajaperumal S,\nBunny Industries has grown into a trusted precision engineering and\nmanufacturing partner for industry leaders. Located in the strategic industrial\ncorridor of Hosur, Tamil Nadu, we engineer high-precision machined components\nto meet the rigorous tolerances demanded by global customers. Backed by a\nskilled workforce and technical specialists, Bunny Industries achieved an\nannual turnover of ₹4.5 Crores in FY 2025–26, demonstrating strong market\npresence and continuous scaling capabilities.\n\n",
    "paragraph2": "",
    ...
    "cards": [
      {
        "title": "OUR VISION",
        "body": "To be a leader in Manufacture of highly Precision Machined Components, Delivering Flawless High Precision Tooling and unparalleled services."
      },
      {
        "title": "OUR MISSION",
        "body": "To deliver zero-defect precision machined components on time, every time, through continually improving the Process, Product and System & powering next-generation industrial growth."
      },
      {
        "title": "OUR VALUES",
        "body": "• Zero Defect  • Micron Precision • Collaboration to reach shared goals         • Lead with integrity • Empowering Leadership • Adaptability Staying flexible"
      }
    ]
  },
  "services": {
    ...
    "projects": [
      {
        "id": 1,
        "title": "VMC",
        "desc": "Premium VMCs from Doosan and Haas with capacities up to 1.2 meters, featuring advanced 4+1 Axis machining for complex geometries and tight tolerances.",
        "img": "/vmc_machine.png"
      },
      {
        "id": 2,
        "title": "CNC Turning & Turnmill",
        "desc": "Advanced LMW CNC Turning Centers and dedicated Turn-Mill Center engineered for high-precision cylindrical parts, threading, and high-volume production runs.",
        "img": "/cnc_machine.png"
      },
      {
        "id": 3,
        "title": "EDM Wire Cutting",
        "desc": "High-precision Excon Wire Cut EDM machines with a 350 x 450 x 450 mm envelope for intricate profiles, tight radii, and hardened exotic conductive alloys.",
        "img": "/wire_cutting_machine.png"
      },
      {
        "id": 4,
        "title": "EDM Sinker",
        "desc": "Electronica Spark Erosion EDM setups delivering micro-level accuracy and fine surface finish on complex, hard-to-machine components without inducing mechanical stress.",
        "img": "/sparking_machine.png"
      },
      {
        "id": 5,
        "title": "Conventional Machineries",
        "desc": "Tool Room & Conventional Machinery\tComprehensive secondary operations support:  Milling Machines, Surface Grinders, Jig Borers, Precision Tapping Machine, and a Conventional Lathe.",
    ...
    "machines": [
      {
        ...
        "items": [
          {
            "make": "Capacities up to 1.2 meters, featuring advanced 4+1 Axis machining.",
            "capacity": "",
            "count": 1
          },
          {
      ...
      },
      {
        ...
        "items": [
          {
            "make": "Engineered for high-precision cylindrical parts, threading, and high-volume production runs.",
            "capacity": "",
            "count": 2
          }
        ]
      },
      {
        ...
        "items": [
          {
            "make": "High-precision Excon Wire Cut EDM machines with a 350 x 450 x 450 mm envelope.",
            "capacity": "",
            "count": 2
          }
        ]
      },
      {
        ...
        "items": [
          {
            "make": "Delivering micro-level accuracy and fine surface finish on complex components.",
            "capacity": "",
            "count": 1
          }
        ]
  ...
  "clients": {
    ...
    "clientList": [
      {
        "name": "M/s Hubbell Services Private Limited",
        "logo": "/hubbell_logo.png",
        "location": "Chennai",
        "products": "VMC Fixtures",
        "since": "2021"
      },
      {
        "name": "ICAM Solutions Private Limited",
        "logo": "/icam_logo.png",
        "location": "Bangalore",
      ...
      },
      {
        ...
        "logo": "/molbio_logo.png",
        "location": "Visakapatnam",
        "products": "Medical Equipment Components",
        "since": "2024"
      },
      {
        "name": "Narasipur Auto Components Private Limited",
        "logo": "/narasipur_logo.png",
        "location": "Bangalore",
        "products": "Fixtures and Machined Components",
        "since": "2021"
      },
      {
        "name": "Manufactec Solutions India Private Limited",
      ...
      },
      {
        ...
        "logo": "/tata_electronics_logo.png",
        "location": "Hosur",
        "products": "Fixtures and Machined Components",
        "since": "2021"
      },
      {
        ...
        "logo": "/schaeffler_logo.png",
        "location": "Hosur",
        "products": "Fixtures & Machined Components",
        "since": "2015"
      },
      {
        "name": "Rangsons Aerospace Private Limited",
        "logo": "/rangsons_logo.png",
        "location": "Bangalore",
        "products": "Fixtures & Aerospace Components",
        "since": "2024"
      },
      {
        "name": "Laversab India Aviation Private Limited",
        "logo": "/laversab_logo.png",
        "location": "Bangaluru",
        "products": "Aerospace Components",
        "since": "2025"
      }
    ...
    "newCertificates": [
      {
        ...
        "img": "https://dgmoij6awx5wsetk.public.blob.vercel-storage.com/ChatGPT%20Image%20Sep%2013%2C%202026%2C%2012_06_53%20PM.png",
        "color": "#C0C0C0",
      ...
      },
      {
        ...
        "img": "https://dgmoij6awx5wsetk.public.blob.vercel-storage.com/WhatsApp_Image_2026-09-12_at_10.24.23_PM-removebg-preview.png",
        "color": "#E74C3C",
    ...
    "qualityFocusPoints": [
      {
        ...
        "desc": "Tight-tolerance CNC, VMC & EDM execution for critical applications."
      },
      {
        "title": "Innovative Solutions",
        "desc": "Continuous investment in advanced CAD/CAM software & modern machine tools."
      },
      {
        "title": "Reliable Partnership",
        "desc": "Over a decade of dependable, on-time delivery records & consistent quality."
      },
      {
        "title": "Industry Expertise",
        "desc": "Proven track record across aerospace, medical & semiconductor programs."
      },
      {
        "title": "One-Stop Solution",
        "desc": "Raw material to finished, inspected part — all under one unified roof."
      },
      {
        "title": "Customer-Centric",
        "desc": "Acting as a seamless, transparent technical extension of your engineering team."
      }
    ]
  },
  "contact": {
